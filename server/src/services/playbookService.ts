...
const BUILTIN_PLAYBOOKS: { name: string; description: string; steps: PlaybookStepInput[] }[] = [
  {
    ...
    steps: [
      { order: 1, title: 'Mapear decisores e contatos', actionType: TaskType.LIGACAO, targetRole: StakeholderRole.INFLUENCIADOR, offsetDays: 0, priority: TaskPriority.HIGH, description: 'Identificar quem decide e quem influencia.' },
      { order: 2, title: 'Ligação de prospecção', actionType: TaskType.LIGACAO, targetRole: StakeholderRole.DECISOR, offsetDays: 2, priority: TaskPriority.HIGH, description: null },
      { order: 3, title: 'Reunião de descoberta', actionType: TaskType.REUNIAO, targetRole: StakeholderRole.DECISOR, offsetDays: 7, priority: TaskPriority.MEDIUM, description: 'Entender necessidades e critérios.' },
      { order: 4, title: 'Apresentação da empresa', actionType: TaskType.APRESENTACAO, targetRole: StakeholderRole.DECISOR, offsetDays: 14, priority: TaskPriority.MEDIUM, description: null },
      { order: 5, title: 'Visita técnica', actionType: TaskType.VISITA, targetRole: StakeholderRole.TECNICO, offsetDays: 21, priority: TaskPriority.MEDIUM, description: null },
      { order: 6, title: 'Envio do pedido de proposta', actionType: TaskType.PROPOSTA, targetRole: StakeholderRole.APROVADOR, offsetDays: 30, priority: TaskPriority.URGENT, description: null },
    ],
  },
  {
    ...
    steps: [
      { order: 1, title: 'Reunião de alinhamento do empreendimento', actionType: TaskType.REUNIAO, targetRole: StakeholderRole.DECISOR, offsetDays: 0, priority: TaskPriority.HIGH, description: null },
      { order: 2, title: 'Visita ao canteiro/obra', actionType: TaskType.VISITA, targetRole: StakeholderRole.TECNICO, offsetDays: 5, priority: TaskPriority.HIGH, description: null },
      { order: 3, title: 'Apresentação técnica da solução', actionType: TaskType.APRESENTACAO, targetRole: StakeholderRole.TECNICO, offsetDays: 12, priority: TaskPriority.MEDIUM, description: null },
      { order: 4, title: 'Follow-up com decisor', actionType: TaskType.LIGACAO, targetRole: StakeholderRole.DECISOR, offsetDays: 20, priority: TaskPriority.MEDIUM, description: null },
      { order: 5, title: 'Pedido de proposta', actionType: TaskType.PROPOSTA, targetRole: StakeholderRole.APROVADOR, offsetDays: 28, priority: TaskPriority.URGENT, description: null },
    ],
  },
];
