...
```env
DATABASE_URL=postgresql://postgres:Ksb%40266338@db.zymcfjbzyfuevsuhjcnl.supabase.co:6543/postgres
NODE_ENV=production
...
- ✅ NODE_ENV - Adicionada  
- ⏳ FRONTEND_URL - Em progresso
- ⏳ JWT_SECRET - Pendente
- ⏳ JWT_REFRESH_SECRET - Pendente
- ⏳ SUPABASE_URL - Pendente
- ⏳ SUPABASE_ANON_KEY - Pendente
- ⏳ SUPABASE_SERVICE_KEY - Pendente
