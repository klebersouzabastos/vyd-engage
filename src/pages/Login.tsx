          ...
          <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6" ref={autoFocusRef}>
            <div className="space-y-2.5">
              ...
              <Input
                ...
                className={`w-full h-12 sm:h-14 px-4 py-3 border rounded-lg bg-card text-gray-900 text-base placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${touchedFields.email && fieldErrors.email ? 'border-red-500' : 'border-gray-300'}`}
                required
            ...
            <div className="space-y-2.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`w-full h-12 sm:h-14 px-4 py-3 pr-14 border rounded-lg bg-card text-gray-900 text-base placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${touchedFields.password && fieldErrors.password ? 'border-red-500' : 'border-gray-300'}`}
                  required
