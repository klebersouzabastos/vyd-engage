          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              ...
              conversations.map((conv) => (
                ...
                >
                  <div className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 ${getChannelColor(conv.lastMessage.type)}`}>
                    {conv.lastMessage.type === "WHATSAPP" ? <MessageSquare size={16} /> : <Mail size={16} />}
                  </div>
          ...
          {!selectedLead ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">Escolha uma conversa na lista para visualizar as mensagens</p>
              </div>
            </div>
          ) : (
            <>
                    ...
                    {messages.map((msg) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {msg.subject && (
                              <p className={`text-xs font-medium mb-1 ${isOutbound ? "text-white/80" : "text-gray-500"}`}>
                                {msg.subject}
                              </p>
                            )}
