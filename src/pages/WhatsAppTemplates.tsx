...
import { ArrowLeft, MessageSquare, Loader2, RefreshCw, CheckCircle, Clock, XCircle, Copy } from "lucide-react";
      ...
      <div className="p-8">
        ...
        {connections.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-lg border border-gray-300">
            ...
            <p className="text-gray-500 mb-4">Configure uma conexão WhatsApp nas Configurações para ver templates</p>
          ...
          <div className="text-center py-16 bg-white rounded-lg border border-gray-300">
            ...
            <p className="text-gray-500 mb-4">
              Templates são gerenciados no painel do Meta Business Suite.
              Apenas conexões com a API Oficial do WhatsApp suportam templates.
            </p>
          </div>
        ) : (
          <>
                  ...
                  >
                    <div className="p-4 border-b border-gray-200">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(template.status)}`}>
                    ...
                    <div className="p-4">
                      {header && (
                        <p className="text-xs font-medium text-gray-700 mb-2">{header}</p>
                      )}
                      {body ? (
                        <p className="text-sm text-gray-600 whitespace-pre-wrap line-clamp-4">{body}</p>
                      ) : (
