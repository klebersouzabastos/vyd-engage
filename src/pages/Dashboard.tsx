            ...
            {(Object.keys(RANGE_LABELS) as RangePreset[]).map((key) => (
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded-md transition-colors whitespace-nowrap ${
                  rangePreset === key ? 'bg-primary text-white' : 'text-gray-600 hover:bg-gray-100'
                }`}
              >
                {RANGE_LABELS[key]}
              </button>
            ...
            {!staleDealsData || staleDealsData.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Deals sem atualização há 5+ dias aparecerão aqui
                </p>
              </div>
            ) : (
          ...
          <div className="bg-gray-50 rounded-lg shadow-sm border border-gray-300">
            ...
            {dashboardLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Seus leads mais recentes aparecerão aqui
                </p>
              </div>
            ) : (
          ...
          <div className="bg-gray-50 rounded-lg shadow-sm border border-gray-300">
            ...
            {dashboardLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Crie tarefas para acompanhar suas atividades
                </p>
              </div>
            ) : (
              <div className="p-6">
