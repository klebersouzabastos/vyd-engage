                ...
                >
                    ...
                    {(lead as any).automations && (lead as any).automations.length > 0 ? (
                      <div className="flex flex-wrap gap-1.5 items-center">
                        ...
                        {(lead as any).automations.length > 2 && (
                          <div className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-gray-100 text-gray-600 text-xs font-medium border border-gray-200" title={`Mais ${(lead as any).automations.length - 2} automação(ões)`}>
                            +{(lead as any).automations.length - 2}
                          </div>
                        )}
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={(e) => { e.preventDefault(); e.stopPropagation(); onDeleteLead(lead.id); }}
