        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => onChangeStatus("CONTACTED")}>Contatado</DropdownMenuItem>
              <DropdownMenuItem onClick={() => onChangeStatus("QUALIFIED")}>Qualificado</DropdownMenuItem>
              <DropdownMenuItem onClick={() => onChangeStatus("PROPOSAL")}>Proposta</DropdownMenuItem>
              <DropdownMenuItem onClick={() => onChangeStatus("NEGOTIATION")}>Negociacao</DropdownMenuItem>
