...
function TaskCardSkeleton() {
  return (
    <div className="bg-card rounded-lg p-4 shadow-sm border border-gray-300 space-y-3">
    ...
    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 min-w-[280px]">
      ...
      <div className="space-y-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-card rounded-lg p-4 border border-gray-200 space-y-2">
