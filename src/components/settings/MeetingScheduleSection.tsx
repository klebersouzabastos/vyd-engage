    ...
    <div className="p-4 rounded-lg border border-gray-300">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Crie links públicos para que leads agendem reuniões diretamente.
          </p>
        </div>
        <Button
          size="sm"
      ...
      {showForm && (
        <div className="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
          <div>
            <label
              htmlFor="meeting-schedule-title"
          ...
          <div>
            <label
              htmlFor="meeting-schedule-duration"
              className="block text-sm font-medium text-gray-700 mb-1"
            >
              Duração (minutos)
            </label>
            <Input
              id="meeting-schedule-duration"
              type="number"
              value={duration}
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => window.open(`/s/${item.slug}`, '_blank')}
                  title="Abrir página"
                >
