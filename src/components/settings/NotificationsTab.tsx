      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch checked={prefs.automations} onCheckedChange={(v) => updatePref("automations", v)} />
          </div>
          <div className="flex items-center justify-between">
            <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch checked={prefs.systemUpdates} onCheckedChange={(v) => updatePref("systemUpdates", v)} />
          </div>
        </div>
      </div>
