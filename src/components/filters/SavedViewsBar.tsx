...
interface SavedViewsBarProps {
  ...
  onSaveView: (name: string, options?: { isDefault?: boolean; isShared?: boolean }) => Promise<void>;
  onUpdateView: (id: string, data: { name?: string; isDefault?: boolean; isShared?: boolean }) => Promise<void>;
        ...
        <DialogContent className="sm:max-w-md bg-white">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!renameViewName.trim() || saving}
            >
              {saving ? "Salvando..." : "Salvar"}
            </Button>
          </DialogFooter>
